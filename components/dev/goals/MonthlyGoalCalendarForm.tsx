    ...
    <div className="mb-4">
      <div className="flex items-center gap-3">
        ...
        {isEditing || !currentMonthlyGoal ? (
          ...
          <div className="group relative flex h-10 flex-1 items-center gap-2 rounded-lg border border-blue-200 bg-blue-50 px-3 py-2 text-sm font-medium text-blue-900 transition-colors hover:bg-blue-100 dark:border-blue-800 dark:bg-blue-950/50 dark:text-blue-100 dark:hover:bg-blue-900/50">
            <div
              role="button"
              tabIndex={0}
            ...
            >
              <span className="truncate">{currentMonthlyGoal.title}</span>
            </div>
